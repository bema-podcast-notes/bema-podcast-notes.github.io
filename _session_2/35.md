...
**Secondary Function - City Business:**
Since cities were only attacked approximately once every 80 years, gates served daily civic purposes:
...
The city gates served as the distribution center for aid to the poor. The wealthy from inside the city would bring their abundance to the gates, where it was rationed and given to those in need from outside the walls.
...
**The Twelve Tribes:**
Originally Jacob's twelve sons, but modified because:
